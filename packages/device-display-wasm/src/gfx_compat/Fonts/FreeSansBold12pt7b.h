// Vendored unmodified from Adafruit GFX Library (Fonts/FreeSansBold12pt7b.h),
// BSD license as in Adafruit_GFX.h, so the browser build renders the same
// glyphs as the device.
#pragma once
